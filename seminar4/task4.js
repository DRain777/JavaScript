...
console.log(`в массиве ${count} раз повторяется цифра 3`);


const arr1 = [1, 2, 3, 2, 4, 3, 5, 6, 3, 2, 3];

const countOfThree = arr1.filter((element) => element === 3).length;

console.log(`The count of digit 3 in the array is: ${countOfThree}`);
